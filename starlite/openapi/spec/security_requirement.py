...
`Security Schemes <https://spec.openapis.org/oas/v3.1.0#componentsSecuritySchemes>`_ under the `Components Object <https://spec.openapis.org/oas/v3.1.0#componentsObject>`_.
...
`OpenAPI Object <https://spec.openapis.org/oas/v3.1.0#oasObject>`_ or `Operation Object <https://spec.openapis.org/oas/v3.1.0#operationObject>`_,
...
in the `Security Schemes <https://spec.openapis.org/oas/v3.1.0#componentsSecuritySchemes>`_ under the `Components Object <https://spec.openapis.org/oas/v3.1.0#componentsObject>`_.
