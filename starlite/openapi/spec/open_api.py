...
from starlite.openapi.spec.server import Server
...
if TYPE_CHECKING:
    ...
    from starlite.openapi.spec.info import Info
    from starlite.openapi.spec.path_item import PathItem
    from starlite.openapi.spec.paths import Paths
    from starlite.openapi.spec.reference import Reference
    from starlite.openapi.spec.security_requirement import SecurityRequirement
    from starlite.openapi.spec.tag import Tag
...
class OpenAPI(BaseSchemaObject):
    ...
    **REQUIRED**. Provides metadata about the API. The metadata MAY be used by tooling as required.
    ...
    openapi: str = "3.1.0"
    """
    **REQUIRED**. This string MUST be the `version number <https://spec.openapis.org/oas/v3.1.0#versions>`_ of the
    OpenAPI Specification that the OpenAPI document uses. The ``openapi`` field SHOULD be used by tooling to interpret t
    he OpenAPI document. This is *not* related to the API
    `info.version <https://spec.openapis.org/oas/v3.1.0#infoVersion>`_ string.
    """
