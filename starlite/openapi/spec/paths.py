...
if TYPE_CHECKING:
    from starlite.openapi.spec import PathItem
...
The Paths MAY be empty, due to `Access Control List (ACL) constraints <https://spec.openapis.org/oas/v3.1.0#securityFiltering>`_.
