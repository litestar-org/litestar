...
class SQLAlchemyConfig(BaseModel):
    ...
    def config_sqlalchemy_logging(self, logging_config: Optional[BaseLoggingConfig]) -> None:
    ...
    @deprecated(version="v1.51.0", removal_in="v2.0.0", alternative="config_sqlalchemy_logging", kind="method")
    def config_sql_alchemy_logging(self, logging_config: Optional[BaseLoggingConfig]) -> None:
        ...
        Returns:
            None.
        """
        self.config_sqlalchemy_logging(logging_config)
