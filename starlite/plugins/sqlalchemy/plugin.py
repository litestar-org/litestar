...
if TYPE_CHECKING:
    ...
    from starlite.plugins.sqlalchemy.config import SQLAlchemyConfig
...
class SQLAlchemyPlugin(PluginProtocol[DeclarativeMeta]):
    ...
    def __init__(self, config: Optional["SQLAlchemyConfig"] = None) -> None:
        ...
        Args:
            config: Optional :class:`SQLAlchemyConfig <starlite.plugins.sqlalchemy.SQLAlchemyConfig>` instance. If
    ...
    def on_app_init(self, app: "Starlite") -> None:
        ...
        if self._config is not None:
            ...
            self._config.config_sqlalchemy_logging(app.logging_config)
