...
from .interface import AbstractDTOInterface
...
def create_dto_extractor(
    parsed_parameter: ParsedParameter, dto_type: type[AbstractDTOInterface]
    ...
    """
    is_dto_annotated = parsed_parameter.parsed_type.is_subclass_of(AbstractDTOInterface)
