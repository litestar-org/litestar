...
user-friend/easy-to-remember and create complex URLs. One way to solve this is to add a
user friendly unique identifier to the table that can be used for urls.  This is often
called a "slug"
...
We are all set to use this in our routes now.  First, we'll convert out incoming
