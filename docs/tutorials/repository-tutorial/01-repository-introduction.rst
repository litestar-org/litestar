...
-----------------------------
In this section we will create our first SQL Alchemy repository by extending our script to include a DTO that will ensure we don't expose
...
The :class:`DTOConfig <litestar.contrib.sqlalchemy.base.UUIDBase>` class is imported from the ``litestar.dto.factory`` module.
