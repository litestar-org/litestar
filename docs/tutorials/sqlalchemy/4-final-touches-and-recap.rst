...
:class:`SQLAlchemyInitPlugin <litestar.plugins.sqlalchemy.SQLAlchemyInitPlugin>` and the
:class:`SQLAlchemySerializationPlugin <litestar.plugins.sqlalchemy.SQLAlchemySerializationPlugin>`, but there
is a shortcut for this configuration: the
:class:`SQLAlchemyPlugin <litestar.plugins.sqlalchemy.SQLAlchemyPlugin>` is a combination of the two, so we
