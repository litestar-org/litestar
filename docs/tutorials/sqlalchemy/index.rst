...
To follow this tutorial, you will need SQLAlchemy installed. You can install it with ``pip install sqlalchemy aiosqlite greenlet``, or let
Litestar install it for you by installing the ``sqlalchemy`` extra (e.g., ``pip install 'litestar[standard,sqlalchemy] aiosqlite greenlet'``).
