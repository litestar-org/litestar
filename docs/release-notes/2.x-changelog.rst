...
.. changelog:: 2.0.0rc1
    ...
    .. change:: Support for server-sent-events
        ...
        .. seealso::
            :ref:`Server Sent Events <usage/responses/special_responses:Server Sent Event Responses>`
...
.. changelog:: 2.0.0alpha3
    ...
    .. change:: `Accept`-header parsing and content negotiation
        ...
        .. seealso::
            :ref:`usage/responses/returning_responses:Content Negotiation`
...
.. changelog:: 2.0.0alpha1
    ...
    .. change::  Unify response headers and cookies
        ...
        :ref:`response headers <usage/responses/headers_and_cookies:Setting Response Headers>` and
        :ref:`response cookies <usage/responses/headers_and_cookies:Setting Response Cookies>` now have the
