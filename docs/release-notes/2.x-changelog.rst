...
.. changelog:: 2.1.0
    ...
    .. change:: SQLAlchemy: Swap to the `advanced_alchemy <https://advanced-alchemy.jolt.rs>`_ implementations
        :type: feature
        :pr: 2312

        Swaps the internal SQLAlchemy repository to use the external
        `advanced_alchemy <https://advanced-alchemy.jolt.rs>`_ library implementations
