...
.. changelog:: 2.8.0
    ...
    .. change:: Set default on schema from :class:`~.typing.FieldDefinition`
        ...
        .. literalinclude:: /examples/changelog/2_8_0.py
            :language: python
...
.. changelog:: 2.6.2
    ...
    .. change:: DTO msgspec meta constraints not being included in transfer model
        ...
        .. literalinclude:: /examples/changelog/2_6_2.py
            :language: python
    ...
    .. change:: Simplified static file handling and enhancements
        ...
        **Usage**
        ...
        Instead of
         ...
         .. literalinclude:: /examples/changelog/2_6_0-1.py
            :language: python


        You can now simply use

        .. literalinclude:: /examples/changelog/2_6_0-2.py
            :language: python
...
.. changelog:: 2.5.1
    ...
    .. change:: Fix OpenAPI schema generation for Union of multiple ``msgspec.Struct``\ s and ``None``
        ...
        .. literalinclude:: /examples/changelog/2_5_1-1.py
            :language: python
...
.. changelog:: 2.5.0
    ...
    .. change:: Fix SSE reverting to default ``event_type`` after 1st message
        ...
        .. literalinclude:: /examples/changelog/2_5_1-2.py
            :language: python
    ...
    .. change:: Correctly handle single file upload validation when multiple files are specified
        ...
        .. literalinclude:: /examples/changelog/2_5_1-3.py
            :language: python
    ...
    .. change:: Fix trailing messages after unsubscribe in channels
        ...
        .. literalinclude:: /examples/changelog/2_5_1-4.py
            :language: python
...
.. changelog:: 2.4.5
    ...
    .. change:: Fix validation of  empty payload data with default values
        ...
        .. literalinclude:: /examples/changelog/2_4_5.py
            :language: python
...
.. changelog:: 2.4.0
    ...
    .. change:: Fix OpenAPI examples format
        ...
        .. literalinclude:: /examples/changelog/2_4_0-1.py
            :language: python
    ...
    .. change:: Fix DTO renaming renames all fields of the same name in nested DTOs
        ...
        .. literalinclude:: /examples/changelog/2_4_0-2.py
            :language: python
    ...
    .. change:: Support nested DTO field renaming
        ...
        .. literalinclude:: /examples/changelog/2_4_0-3.py
            :language: python
...
.. changelog:: 2.3.2
    ...
    .. change:: Fix recursion error when re-using the path of a route handler for static files
        ...
        .. literalinclude:: /examples/changelog/2_3_2.py
            :language: python
...
.. changelog:: 2.3.0
    ...
    .. change:: Support Pydantic 1 & 2 within the same application
        ...
        .. literalinclude:: /examples/changelog/2_3_0-1.py
            :language: python
    ...
    .. change:: Fix missing OpenAPI schema for generic response type annotations
        ...
        .. literalinclude:: /examples/changelog/2_3_0-2.py
            :language: python
    ...
    .. change:: Fix ``ExceptionHandler`` typing to properly support ``Exception`` subclasses
        ...
        .. literalinclude:: /examples/changelog/2_3_0-3.py
            :language: python
...
.. changelog:: 2.2.0
    ...
    .. change:: Add experimental DTO codegen backend
        ...
        .. literalinclude:: /examples/changelog/2_2_0.py
            :language: python
...
.. changelog:: 2.1.0
    ...
    .. change:: SQLAlchemy: Exclude implicit fields for SQLAlchemy DTO
        ...
        .. literalinclude:: /examples/changelog/2_1_0-1.py
            :language: python
        ...
        .. literalinclude:: /examples/changelog/2_1_0-2.py
            :language: python
    ...
    .. change:: SQLAlchemy: Allow repository functions to be filtered by expressions
        ...
        .. literalinclude:: /examples/changelog/2_1_0-3.py
            :language: python


        instead of the previous method of overriding the ``statement``:

        .. literalinclude:: /examples/changelog/2_1_0-4.py
            :language: python
...
.. changelog:: 2.0.0rc1
    ...
    .. change:: Support for server-sent-events
        ...
        .. literalinclude:: /examples/changelog/2_0_0_rc1.py
            :language: python
...
.. changelog:: 2.0.0beta1
    ...
    .. change:: DTOs: Arbitrary generic wrappers
        ...
        .. literalinclude:: /examples/changelog/2_0_0_beta1-1.py
            :language: python
    ...
    .. change:: Remove ``state`` parameter from ``AfterExceptionHookHandler`` and ``BeforeMessageSendHookHandler``
        ...
        .. literalinclude:: /examples/changelog/2_0_0_beta1-2.py
            :language: python


        to

        .. literalinclude:: /examples/changelog/2_0_0_beta1-3.py
            :language: python


        The state can still be accessed like so:

        .. literalinclude:: /examples/changelog/2_0_0_beta1-4.py
            :language: python


        ``BeforeMessageSendHookHandler``\ s will have to be updated from

        .. literalinclude:: /examples/changelog/2_0_0_beta1-5.py
            :language: python


        to

        .. literalinclude:: /examples/changelog/2_0_0_beta1-6.py
            :language: python


        where state can be accessed in the same manner:

        .. literalinclude:: /examples/changelog/2_0_0_beta1-7.py
            :language: python
...
.. changelog:: 2.0.0alpha4
    ...
    .. change:: :class:`Annotated <typing.Annotated>` support for route handler and dependency annotations
        ...
        .. literalinclude:: /examples/changelog/2_0_0_alpha4-1.py
            :language: python


        .. literalinclude:: /examples/changelog/2_0_0_alpha4-2.py
            :language: python
...
.. changelog:: 2.0.0alpha3
    ...
    .. change:: Fix SQLAlchemy 1 Plugin - ``'Request' object has no attribute 'dict'``
        ...
        .. literalinclude:: /examples/changelog/2_0_0_alpha3-1.py
            :language: python
    ...
    .. change:: Support OpenAPI schema generation with stringized return annotation
        ...
        .. literalinclude:: /examples/changelog/2_0_0_alpha3-2.py
            :language: python
...
.. changelog:: 2.0.0alpha2
    ...
    .. change:: Replace ``Starlite()`` ``initial_state`` keyword argument with ``state``
        ...
        .. literalinclude:: /examples/changelog/2_0_0_alpha2-1.py
            :language: python


        to

        .. literalinclude:: /examples/changelog/2_0_0_alpha2-2.py
            :language: python
