...
async def login(data: UserLoginPayload, request: "Request[Any, Any, Any]") -> User:
    ...
    user_id = await memory_storage.get(data.email)
...
async def signup(data: UserCreatePayload, request: Request[Any, Any, Any]) -> User:
    ...
    await memory_storage.set(data.email, str(user.id))
...
session_auth = SessionAuth[User, ServerSideSessionBackend](
    ...
    session_backend_config=ServerSideSessionConfig(storage=memory_storage),
