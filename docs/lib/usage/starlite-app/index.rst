...
At the root of every Starlite project is an instance of the :class:`Starlite <starlite.app.Starlite>` class and this code
...
Routers and Router Handlers should be registered on it.
