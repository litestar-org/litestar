...
In the previous introductory section of the documentations we briefly mentioned the root
...
based on certain ASGI events. This section of the documentations takes a deeper dive into how you
can use those hooks to configure your application throughout its lifespan.

Brief Overview of Application Hooks & Their Respective Events
-------------------------------------------------------------
...
tracing, logging & such. So without further adieu, let's take a look at some real-world code snippets showcasing these
Starlite hooks.
...
To configure your application to behave in certain ways before & after it starts, Starlite provides the handy
