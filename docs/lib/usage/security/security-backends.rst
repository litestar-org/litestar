...
:doc:`/lib/reference/security/index` includes an :class:`AbstractSecurityConfig <.security.base.AbstractSecurityConfig>` class
...
:ref:`session backends <lib/usage/middleware/builtin-middleware:session middleware>` supported by the Starlite session
middleware.
...
the :doc:`jwt contrib documentation </lib/usage/contrib/jwt>` for more details.
