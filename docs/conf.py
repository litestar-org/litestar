...
nitpick_ignore = [
    ...
    (PY_CLASS, "litestar.plugins.sqlalchemy.Empty"),
    ...
    (PY_CLASS, "litestar.plugins.sqlalchemy.SQLAlchemyDTO"),
    (PY_CLASS, "litestar.plugins.sqlalchemy.SQLAlchemySyncConfig"),
    (PY_CLASS, "litestar.plugins.sqlalchemy.SQLAlchemyAsyncConfig"),
    (PY_CLASS, "litestar.plugins.sqlalchemy.EngineConfig"),
    (PY_CLASS, "litestar.plugins.sqlalchemy.AsyncSessionConfig"),
    (PY_CLASS, "litestar.plugins.sqlalchemy.SyncSessionConfig"),
    ...
    (PY_ATTR, "litestar.plugins.sqlalchemy.SQLAlchemyAsyncConfig.engine_dependency_key"),
    (PY_ATTR, "litestar.plugins.sqlalchemy.SQLAlchemyAsyncConfig.session_dependency_key"),
    (PY_ATTR, "litestar.plugins.sqlalchemy.SQLAlchemySyncConfig.engine_dependency_key"),
    (PY_ATTR, "litestar.plugins.sqlalchemy.SQLAlchemySyncConfig.session_dependency_key"),
    (PY_ATTR, "litestar.plugins.sqlalchemy.SQLAlchemyAsyncConfig.before_send_handler"),
    (PY_ATTR, "litestar.plugins.sqlalchemy.SQLAlchemySyncConfig.before_send_handler"),
...
nitpick_ignore_regex = [
    ...
    (PY_RE, r"litestar\.plugins\.sqlalchemy\.filters.*"),
    (PY_RE, r"litestar\.plugins\.sqlalchemy\.repository.*"),
    (PY_RE, r"litestar\.plugins\.sqlalchemy\.types.*"),
    (PY_RE, r"litestar\.plugins\.sqlalchemy\.service.*"),
