...
nitpick_ignore = [
    ...
    (PY_CLASS, "advanced_alchemydto.SQLAlchemyDTO"),
    (PY_CLASS, "advanced_alchemytypes.BigIntIdentity"),
    (PY_CLASS, "advanced_alchemytypes.JsonB"),
...
nitpick_ignore_regex = [
    ...
    (PY_RE, r"ModelT"),
    (PY_RE, r"litestar.*\.T"),
    (PY_RE, r"advanced_alchemyrepository.ModelT"),
