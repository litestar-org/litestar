...
supporting :class:`~dataclasses.dataclass`, :class:`~typing.TypedDict`,
...
:ref:`specific kwargs on route <openapi/schema_generation:Configuring schema generation on a route handler>`
handler decorators.
