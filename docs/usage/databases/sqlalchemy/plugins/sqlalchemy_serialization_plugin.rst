...
.. tab-set::
   ...
   .. tab-item:: Async
        ...
        .. literalinclude:: /examples/sqlalchemy/plugins/sqlalchemy_async_serialization_plugin.py
   ...
   .. tab-item:: Sync
        ...
        .. literalinclude:: /examples/sqlalchemy/plugins/sqlalchemy_sync_serialization_plugin.py
...
.. tab-set::
   ...
   .. tab-item:: Data Transfer Object
        ...
        .. literalinclude:: /examples/sqlalchemy/plugins/sqlalchemy_async_serialization_dto.py
            :language: python
            :linenos:
...
.. tab-set::
   ...
   .. tab-item:: Async
        ...
        .. literalinclude:: /examples/sqlalchemy/plugins/sqlalchemy_async_serialization_plugin_marking_fields.py
   ...
   .. tab-item:: Sync
        ...
        .. literalinclude:: /examples/sqlalchemy/plugins/sqlalchemy_sync_serialization_plugin_marking_fields.py
