...
can be any callable accepting a :class:`Request <starlite.Request>` as its first parameter
...
has been resolved. It can be any callable which takes a :class:`Response <starlite.Response>`
...
It can be any callable accepting a :class:`Request <starlite.Request>` as its first parameter
...
.. admonition:: Layered architecture
    ...
    :ref:`Layered architecture <lib/usage/the-starlite-app:layered architecture>`
