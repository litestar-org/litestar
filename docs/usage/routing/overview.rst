...
.. caution::
    ...
    Although Litestar exposes the :meth:`register <.router.Router.register>` method, it should not be abused. Dynamic
...
Litestar support "mounting" ASGI applications on sub paths, that is - specifying a handler function that will handle all
