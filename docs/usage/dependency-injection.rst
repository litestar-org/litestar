...
.. literalinclude:: /examples/dependency_injection/dependency_default_no_dependency_fn.py
...
.. literalinclude:: /examples/dependency_injection/dependency_default_with_dependency_fn.py
    :caption: Dependency with default value
    :language: python
