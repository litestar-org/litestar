...
1. `Fork <https://github.com/starlite-api/litestar/fork>`_ the `Litestar repository <https://github.com/starlite-api/litestar>`_
...
1. Increment the version in ``pyproject.toml`` according to the
   `versioning scheme <https://litestar-api.github.io/litestar/latest/litestar-releases.html#version-numbering>`_
2. `Draft a new release <https://github.com/starlite-api/litestar/releases/new>`_ on GitHub
...
6. Check that the "publish" `action <https://github.com/starlite-api/litestar/actions>`_ has run successfully
