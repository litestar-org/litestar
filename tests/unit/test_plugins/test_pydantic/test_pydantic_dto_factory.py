...
def test_detect_nested_field(base_model: type[pydantic_v2.BaseModel]) -> None:
...
def test_pydantic_dto_annotated_dto_field(base_model: type[pydantic_v2.BaseModel]) -> None:
