...
def test_exception_handler_middleware_exception_handlers_mapping() -> None:
    ...
    scope = {"path": "/", "type": "http", "method": "GET"}
    asgi_handler: Any = app.route_map.resolve_asgi_app(scope)
    assert asgi_handler.exception_handlers == {Exception: exception_handler}
