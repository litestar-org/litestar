...
def __getattr__(attr_name: str) -> object:
    if attr_name in __all__:
        from advanced_alchemy.repository import (
            SQLAlchemySyncRepository,  # type: ignore[import-not-found]  # pyright: ignore[reportMissingImports,reportUnusedImport]
        )
...
if TYPE_CHECKING:
    from advanced_alchemy.repository import (
        SQLAlchemySyncRepository,  # type: ignore[import-not-found]  # pyright: ignore[reportMissingImports]
    )
