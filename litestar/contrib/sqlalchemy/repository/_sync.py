...
def __getattr__(attr_name: str) -> object:
    from advanced_alchemy.extensions.litestar.repository import SQLAlchemySyncRepository # type: ignore[import-not-found] # pyright: ignore[reportMissingImports]
...
if TYPE_CHECKING:
    from advanced_alchemy.extensions.litestar.repository import SQLAlchemySyncRepository # pyright: ignore[reportMissingImports]
