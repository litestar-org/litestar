...
AsyncExceptionHandler: TypeAlias = "Callable[[Request, ExceptionT], Awaitable[Response]]"
SyncExceptionHandler: TypeAlias = "Callable[[Request, ExceptionT], Response]"
ExceptionHandler: TypeAlias = "AsyncExceptionHandler | SyncExceptionHandler"
