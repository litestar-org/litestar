...
class KwargsModel:
    ...
    def create_for_signature_model(
        ...
        cls._validate_dependencies_annotations(
            ...
            handler_params=parsed_signature.parameters,
            dependencies=dependencies,
        )
    ...
    def _validate_dependencies_annotations(
        cls,
        handler: str,
        handler_params: dict[str, FieldDefinition],
        ...
        It will raise a ``ImproperlyConfiguredException`` if the dependency returns a given type annotation that is
        incompatible with the handler expected type annotation (eg. dependency return type annotation is ``str`` but
        handler expects ``int``).
        ...
        Raises:
            ImproperlyConfiguredException: If the dependency return type annotation is incompatible with the handler
