...
class AbstractAsyncRepository(Generic[T], metaclass=ABCMeta):
    ...
    @abstractmethod
    async def add(self, data: T | dict[str, Any], **kwargs: Any) -> T:
    ...
    @abstractmethod
    async def add_many(self, data: Sequence[T | dict[str, Any]], **kwargs: Any) -> Sequence[T]:
    ...
    @abstractmethod
    async def update(self, data: T | dict[str, Any], **kwargs: Any) -> T:
    ...
    @abstractmethod
    async def upsert(self, data: T | dict[str, Any], **kwargs: Any) -> T:
