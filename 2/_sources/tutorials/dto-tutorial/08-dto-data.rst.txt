...
The solution to this is the :class:`DTOData <litestar.dto.factory.DTOData>` type.
...
The :class:`DTOData <litestar.dto.factory.DTOData>` type is a container for data that can be used to create instances,
...
:meth:`create_instance <litestar.dto.factory.DTOData.create_instance>` method of the ``DTOData`` instance.
