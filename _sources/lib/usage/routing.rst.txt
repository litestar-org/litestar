...
.. seealso::
   ...
   `this GitHub issue <https://github.com/starlpytestite-api/starlite/issues/177>`_ - it includes
...
many `route handler methods <lib/usage/router-handlers:http route handlers>`_ on a controller,
