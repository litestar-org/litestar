...
.. literalinclude:: /examples/contrib/sqlalchemy/plugins/tutorial/full_app_with_session_di.py
    :language: python
    :linenos:
    :emphasize-lines: 48-58,83-84,88-90,95-96,104
...
:data:`~litestar.di.NamedDependency`. The marker tells Litestar to supply the value from the ``transaction`` dependency
